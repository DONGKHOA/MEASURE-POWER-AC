...
{
  cJSON *p_energy = cJSON_CreateNumber(*s_things_board_data.p_energy_hour);
  return p_energy;
}
...
{
  cJSON *p_energy_day = cJSON_CreateNumber(*s_things_board_data.p_energy_day);
  return p_energy_day;
}
...
{
  cJSON *p_energy_week = cJSON_CreateNumber(*s_things_board_data.p_energy_week);
...
{
  cJSON *p_energy_year = cJSON_CreateNumber(*s_things_board_data.p_energy_year);
