...
BSP/DMA/%.o BSP/DMA/%.su BSP/DMA/%.cyclo: ../BSP/DMA/%.c BSP/DMA/subdir.mk
...
clean: clean-BSP-2f-DMA

clean-BSP-2f-DMA:
	-$(RM) ./BSP/DMA/dma.cyclo ./BSP/DMA/dma.d ./BSP/DMA/dma.o ./BSP/DMA/dma.su

.PHONY: clean-BSP-2f-DMA
